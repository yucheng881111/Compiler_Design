...
static std::string getParametersTypeString(const FunctionNode::DeclNodes &p_parameters) {
...
std::string FunctionNode::getParaTypeString(){
    std::string s = getParametersTypeString(m_parameters);
    return s;
}
